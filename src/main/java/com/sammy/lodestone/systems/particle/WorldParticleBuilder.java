package com.sammy.lodestone.systems.particle;
...
public class WorldParticleBuilder {
	...
	public WorldParticleBuilder setRenderType(ParticleTextureSheet textureSheet) {
		options.textureSheet = textureSheet;
		return this;
	}
