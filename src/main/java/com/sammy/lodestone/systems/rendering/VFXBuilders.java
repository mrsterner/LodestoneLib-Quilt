...
public class VFXBuilders {
	...
	public static class ScreenVFXBuilder {
		...
		public ScreenVFXBuilder end() {
			...
			BufferRenderer.drawWithShader(renderedBuffer);
			return this;
		}
	...
	public static class WorldVFXBuilder {
		...
		public WorldVFXBuilder renderQuad(VertexConsumer vertexConsumer, MatrixStack stack, Vec3f[] positions) {
			Matrix4f last = stack.peek().getModel();
		...
		public WorldVFXBuilder renderSphere(VertexConsumer vertexConsumer, MatrixStack stack, float radius, int longs, int lats) {
			...
			for (int i = 0; i < longs; ++i) {
				...
				for (int j = 0; j < lats; ++j) {
					...
					supplier.placeVertex(vertexConsumer, last, p0.getX(), p0.getY(), p0.getZ(), textureU, textureV);
					supplier.placeVertex(vertexConsumer, last, p2.getX(), p2.getY(), p2.getZ(), textureUN, textureV);
					supplier.placeVertex(vertexConsumer, last, p1.getX(), p1.getY(), p1.getZ(), textureU, textureVN);

					supplier.placeVertex(vertexConsumer, last, p3.getX(), p3.getY(), p3.getZ(), textureUN, textureVN);
					supplier.placeVertex(vertexConsumer, last, p1.getX(), p1.getY(), p1.getZ(), textureU, textureVN);
					supplier.placeVertex(vertexConsumer, last, p2.getX(), p2.getY(), p2.getZ(), textureUN, textureV);
				}
			}
